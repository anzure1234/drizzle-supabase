    ...
    return (
        <div className="container mx-auto p-4">
            <header className="text-center mb-8">
                ...
                <p className="text-xl">Current
                    Week: {format(currentWeekStart, "MMMM d")} - {format(addDays(currentWeekStart, 6), "MMMM d, yyyy")}</p>
                <p className="text-xl">Next
            ...
            <div className="mt-8">
                ...
                {Array.from(orders).map(([dateString, meal]) => (
                    <div key={dateString} className="mb-2">
                        <span
                            className="font-semibold">{format(new Date(dateString), "EEEE, MMMM d")}:</span> {meal.name}
                    </div>
                ))}
            </div>
        </div>
